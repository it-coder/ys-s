<template>
  <div class="m-item">
    <item-title title="基线（最近7天）" />
    <div class="m-content">
      <div class="circle-chart">
        <div class="pie-ech">
          <div id="pie-charts-act-ll3_3"></div>
          <div class="indicator">
...
const lineEchartInit = () => {
  const chartDom = document.getElementById("line-charts-ll0_2");
...
const echartInit = () => {
  const chartDom = document.getElementById("pie-charts-act-ll3_3");
