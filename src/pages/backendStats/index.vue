      ...
      <el-row>
        ...
        <el-col :span="19">
          <div class="inner">
            ...
            <div class="stats">
              <div class="compresive">
                <div class="stat-item">
                  <img src="@/assets/images/i_9.png" />
                  <div>
                    <p>1920</p>
                    <p>物理机数</p>
                  </div>
                ...
                <div class="stat-item">
                  <img src="@/assets/images/i_11.png" />
                  <div>
                    <p>1920</p>
                    <p>产品数</p>
                  </div>
                ...
                <div class="stat-item">
                  <img src="@/assets/images/i_12.png" />
                  <div>
                    <p>1920</p>
                    <p>宿主机数</p>
                  </div>
                ...
                <div class="stat-item">
                  <img src="@/assets/images/i_13.png" />
                  <div>
                    <p>1920</p>
                    <p>容器在线数</p>
                  </div>
                ...
                <div class="stat-item">
                  <img src="@/assets/images/i_14.png" />
                  <div>
                    <p>1920</p>
                    <p>容器总数</p>
                  </div>
              ...
              <div class="line-charts-wrap">
                <p class="sub-title">产品物理机统计</p>
                <div class="line-charts" id="line-charts__1"></div>
              </div>
              <div class="line-charts-wrap">
                <p class="sub-title">盘古近一月水位</p>
                <div class="line-charts" id="line-charts__2"></div>
              </div>
            </div>
          </div>
        </el-col>
    ...
    series: [
      {
        ...
        data: [18, 22, 7, 13, 25, 30, 34, 24, 53, 23, 53],
      },
    ],
  },
});
...
onMounted(() => {
  const chartDom = document.getElementById("line-charts__2");
  const myChart = echarts.init(chartDom);
  myChart.setOption(data.option);

  const chartDom2 = document.getElementById("line-charts__1");
  const myChart2 = echarts.init(chartDom2);
  myChart2.setOption(barData.option);
});
</script>
