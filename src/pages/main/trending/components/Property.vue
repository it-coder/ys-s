  ...
  <div class="m-item">
    ...
    <div class="m-content">
      <div class="circle-chart">
        <div class="pie-ech">
          <div id="pie-charts-act-ll3_1"></div>
          <div class="indicator">
...
const config = reactive({
  ...
  data: tableData.map((item) => {
    return [
      item[0],
      `<p style="width: 8px;height: 8px;background: ${
        colorMap[item[1]]
      };border-radius: 50%; transform: translateY(18px)"></p>`,
    ];
  }),
  rowNum: 5,
  columnWidth: [220, 60],
    ...
    return [
      `<div class="item">
        <div class="desc" style="max-width: 90%">
          <p class="oneline"  style="width: 100%">${item[0]}</p>
        </div>
        <span class="table-icon" data-statue="${item[1]}"></span>
      </div>`,
    ];
  });
}
...
const echartInit = () => {
  const chartDom = document.getElementById("pie-charts-act-ll3_1");
